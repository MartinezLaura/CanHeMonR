...
#' @param training_path Path to the rds data that contains the data.frame, with in the column 'pres' 1/0 to indicate presence absence, then covariate columns, and a colum 'class' groupin grows by
...
# tt <- calibrate_sicktree_model_multi_tile (vuln_classes = list(c('Pb')), training_path = ('/home/martlur/Documents/Results/Rcode/maxentCastelobranco100.rdsdata'),
#                                                   model_outp_dir = ('/home/martlur/Documents/Results/Rcode/'))
#' }
#'
#'
#' @export
calibrate_sicktree_model_multi_tile <- function(vuln_classes = 'ALL', training_path, model_outp_dir){
  ...
  #It should be at most the total amount of phisical memory
  options(java.parameters = "-Xmx32861248k")
  #+++++++++++++++++++++++++++++++++++++++++++++++
  #run in R 32 bit
  ...
  for (class in vuln_classes){
    ...
    model.file <- paste0(model_outp_dir,paste0("sampdoble_",class,".rdsdata"))
