...
# tt <-  sample_for_sicktree_model_multi_tile(r_train_dir <-'/home/martlur/Documents/Dockers/docker6/data_test_docker/', tile = 'ALL', vuln_classes <- list(c('Pb')),
...
#                                             field_name = 'type', ninputs_tile = 27, data_outp_dir <- '/home/martlur/Documents/Results/Rcode/Testsample/', abs_samp = 10000,
#                                             parallel = T, nWorkers = 50, data_outp_name = "maxentproba4img")
#'}
#' @export
sample_for_sicktree_model_multi_tile <- function(r_train_dir, tile = 'ALL', vuln_classes, training_pol_filename, field_name, ninputs_tile, data_outp_dir, abs_samp = 1000,
  ...
  if (tile[1] == 'ALL'){
    ...
    #only keep the original tiles and avid to duplicate the basename. Ex: pt617000_4404000 and pt617000-4404000
